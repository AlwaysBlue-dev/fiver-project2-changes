...
<div class="col-lg-8">
	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="chatRoom" style="background-color: #fff;">
		<thead>
			<tr>
				<th style="background-color: #fff" ;>Chat Room Name</th>
				<th>Date Created</th>
