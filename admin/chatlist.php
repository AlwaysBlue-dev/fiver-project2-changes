<div class="col-lg-12">
	<div class="panel panel-default" style="height:50px;">
		...
		<div class="pull-right" style="margin-right:10px; margin-top:7px;">
			<a href="#add_chatroom" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add Chat Room</a>
			<a href="./add_coins.php" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-plus"></span> Add Coins</a>
			<a href="./remove_coins.php" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Remove Coins</a>
		</div>
	</div>
